...
def make_plots(output_folder="guarding-policies/static-guarding-model-v1/find_boundary_patch_reward_penalty_values-v2"):
    ...
    df = pd.read_csv("guarding-policies/static-guarding-model-v1/find_boundary_patch_reward_penalty_values-v2/boundary_patch_reward_penalty_matrix.csv")
    ...
    plt.savefig(os.path.join(output_folder, "boundary_patches_with_rewards_top_k.png"), dpi=750, bbox_inches='tight')
