...
def run_model_01(year, month, mon_len, prob_food_forest, prob_food_cropland, prob_water, food_val_forest, food_val_cropland, threshold, aggression, model):
    ...
    output_folder = os.path.join( os.getcwd(), "sensitivity_analysis/outputs/forest-food-percent/", expt_name, output, food_val, temp_threshold, elephant_category, expt_id, "model_" + model, month)
...
for prob_food_forest in [0.08, 0.09, 0.1, 0.11, 0.12]:
