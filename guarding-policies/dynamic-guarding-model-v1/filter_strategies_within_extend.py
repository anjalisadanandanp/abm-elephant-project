...
input_file = "guarding-policies/dynamic-guarding-model-v1/create-strategy-matrix-v2/boundary_raster_discretised_600m/boundary_raster_discretised.tif"

latlon_extent = (8563700, 1043400, 8574155, 1056000) 

targets = clip_raster_by_latlon_extent(input_file, latlon_extent)

reward_df = pd.read_csv("guarding-policies/dynamic-guarding-model-v1/find_boundary_patch_reward_penalty_values-v2_4/boundary_raster_discretised_600m/boundary_patch_reward_penalty_matrix.csv")
sorted_df = reward_df.sort_values(by='reward', ascending=False)

boundary_patches = gdal.Open("guarding-policies/dynamic-guarding-model-v1/create-strategy-matrix-v2/boundary_raster_discretised_600m/boundary_raster_discretised.tif")
