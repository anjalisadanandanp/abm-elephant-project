...
if __name__ == "__main__":
    ...
    model_params = {
            ...
            "elephant_starting_latitude": [[1051169, 1044999, 1046859]],
            "elephant_starting_longitude": [[8572676, 8572569, 8567834]],
    ...
    output_folder = os.path.join(
        "/mnt/qdata/abm-elephant-project/pampa-runs/convergence-of-attacker-trajectories-multiple-starts/",
        experiment_name,
        starting_location,
        elephant_category,
