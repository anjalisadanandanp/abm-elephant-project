...
for max_cells_per_group in tqdm([5, 10, 15, 20, 25, 30, 35, 40, 45, 50]):
    ...
    save_folder = os.path.join("guarding-policies/dynamic-guarding-model-v1/find_boundary_patch_reward_penalty_values-v2_1/boundary_raster_discretised_" + str(int(max_cells_per_group*30)) + "m")
