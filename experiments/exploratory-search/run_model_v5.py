...
from mesageo_elephant_project.elephant_project.model.abm_model_HEC_v5 import batch_run_model
#------------importing libraries----------------#
...
def generate_parameter_combinations(model_params_all):
    ...
    density_factor = model_params_all["density_factor"]
...
def run_model(experiment_name, model_params):
    ...
    density_factor = "density_factor_" + str(model_params["density_factor"])
