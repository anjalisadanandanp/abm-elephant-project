...
module = importlib.import_module('guarding-policies.FPL-UE_no-memory-model-v1_2.abm_model_HEC_with_landscape_deterrent_policies_without_ranger_proximity')
...
def create_defender_coverage_matrix(defender_strategy):
    ...
    plt.savefig("guarding-policies/FPL-UE_no-memory-model-v1_2/coverage_matrix.png", dpi=300, bbox_inches="tight")
    #-----------plot coverage matrix#-----------#
