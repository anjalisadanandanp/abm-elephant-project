...
module = importlib.import_module('guarding-policies.FPL-UE_learning-memory-v1_1.abm_model_HEC_with_landscape_deterrent_policies_with_ranger_proximity_learning_model')
...
def create_defender_coverage_matrix(defender_strategy):
    ...
    plt.savefig("guarding-policies/FPL-UE_learning-memory-v1_1/coverage_matrix.png", dpi=300, bbox_inches="tight")
    #-----------plot coverage matrix#-----------#
...
if __name__ == "__main__":
    ...
    output_file = os.path.join("guarding-policies/FPL-UE_learning-memory-v1_1/defender_coverage_matrix.tif")
    ...
    for ranger_proximity_threshold, cost_ranger_proximity_threshold in parameter_combinations:
        ...
        for k in num_resources_k: 
            ...
            output_folder = os.path.join(
                "guarding-policies/FPL-UE_learning-memory-v1_1/model-runs/game_model-v3_1-run-model-with-intervention-v2-no-knowledge/",
                experiment_name,
                starting_location,
                elephant_category,
