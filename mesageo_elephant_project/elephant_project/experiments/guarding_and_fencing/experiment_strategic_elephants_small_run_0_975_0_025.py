...
from mesageo_elephant_project.elephant_project.model.abm_model_HEC_strategic_elephants_0_975_0_025 import batch_run_model
...
def run_model(year, month, mon_len, prob_food_forest, prob_food_cropland, prob_water, food_val_forest, food_val_cropland, threshold, aggression, model):
    ...
    output_folder = os.path.join( os.getcwd(), "mesageo_elephant_project/elephant_project/outputs/strategic_elephants_small_run_0_975_0_025/guarding_and_fencing/action_prob_" + str(action_prob) + "/", expt_name, output, food_val, temp_threshold, elephant_category, expt_id, "model_" + model, month)
...
def run_models():
    ...
    folder = os.path.join(os.getcwd(), "mesageo_elephant_project/elephant_project/outputs/strategic_elephants_small_run_0_975_0_025")
