...
class Building_classification():
    ...
    def function_classify_residential_and_commercial_buildings(self, Village, total_number_of_buildings):
        ...
        fid = os.path.join("Environment_seethathode", "geojson_files", Village+".geojson")
        data = json.load(open(fid))

        fid = os.path.join("Environment_seethathode","shape_files")
        ...
        population = "Environment_seethathode/Raster_Files_Seethathode_Derived/area_1100sqKm/reso_30x30/Population.tif"
