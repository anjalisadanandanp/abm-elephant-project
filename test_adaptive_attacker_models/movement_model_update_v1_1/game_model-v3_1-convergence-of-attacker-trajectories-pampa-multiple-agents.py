...
module = importlib.import_module('test_adaptive_attacker_models.movement_model_update_v1_1.abm_model_HEC_with_landscape_deterrent_policies')
...
if __name__ == "__main__":
    ...
    output_folder = os.path.join(
        "/mnt/qdata/abm-elephant-project/pampa-runs/test_adaptive_attacker_models/movement_model_update_v1_1/",
        experiment_name,
        starting_location,
        elephant_category,
