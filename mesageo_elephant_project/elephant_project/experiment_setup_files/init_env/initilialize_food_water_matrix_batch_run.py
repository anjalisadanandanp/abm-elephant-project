...
class environment(environment):
    ...
    def initialize_food_matrix(self, Prob_food_in_forest, Prob_food_in_cropland):
        ...
        fid = os.path.join("mesageo_elephant_project/elephant_project/experiment_setup_files","simulation_results_batch_run","food_and_water_matrix", "food_matrix_"+ str(Prob_food_in_forest) + "_" + str(Prob_food_in_cropland) + "_.tif")
    ...
    def initialize_water_matrix(self,Prob_water):
        ...
        fid = os.path.join("mesageo_elephant_project/elephant_project/experiment_setup_files","simulation_results_batch_run","food_and_water_matrix", "water_matrix_" + str(Prob_water) +"_.tif")
