...
if __name__ == "__main__":
    ...
    for max_cells_per_group in [40, 45, 50]:

        create_combined_raster(
            output_dir='guarding-policies/dynamic-guarding-model-v1/create-strategy-matrix-v2', max_cells_per_group=max_cells_per_group
        )

        plot_discretised_raster(output_dir='guarding-policies/dynamic-guarding-model-v1/create-strategy-matrix-v2/boundary_raster_discretised_' + str(int(max_cells_per_group*30)) + 'm')