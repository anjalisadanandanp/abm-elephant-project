...
from mesageo_elephant_project.elephant_project.model.abm_model_HEC_strategic_elephants_0_025_0_975 import batch_run_model
...
fixed_params = {
    ...
    "radius_food_search": 725,     
    "radius_water_search": 725, 
...
def run_model(year, month, mon_len, prob_food_forest, prob_food_cropland, prob_water, food_val_forest, food_val_cropland, threshold, aggression, model):
    ...
    expt_name = "guarding_and_fencing"
    ...
    output_folder = os.path.join( os.getcwd(), "mesageo_elephant_project/elephant_project/outputs/strategic_elephants_small_run_0_025_0_975/guarding_and_fencing/action_prob_" + str(action_prob) + "/", expt_name, output, food_val, temp_threshold, elephant_category, expt_id, "model_" + model, month)
...
def run_models():
    ...
    folder = os.path.join(os.getcwd(), "mesageo_elephant_project/elephant_project/outputs/strategic_elephants_small_run_0_025_0_975")
    ...
    for month_idx in [3, 8]:
        ...
        p1 = multiprocessing.Process(target=run_model, args=(year, month, num_days, prob_food_forest, prob_food_cropland, prob_water, 5, food_val_cropland, threshold, aggression, model))
...
# folder = os.path.join(os.getcwd(), "mesageo_elephant_project/elephant_project/outputs/strategic_elephants_small_run")
# os.system("rm -rf " + folder)
#---------------------------------------------------------#

for aggression in aggression_values:
    for action_prob in [0.0, 0.5, 1.0]:
        run_models()