...
module = importlib.import_module('guarding-policies.HERDS_learning-memory-v1_1.abm_model_HEC_with_landscape_deterrent_policies_with_ranger_proximity_learning_model')
...
def create_defender_coverage_matrix(defender_strategy):
    ...
    plt.savefig("guarding-policies/HERDS_learning-memory-v1_1/coverage_matrix.png", dpi=300, bbox_inches="tight")
    #-----------plot coverage matrix#-----------#
