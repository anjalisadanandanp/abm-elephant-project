...
module = importlib.import_module('guarding-policies.abm-runs-learning-memory.abm_model_HEC_with_landscape_deterrent_policies_with_ranger_proximity_learning_model')
...
def create_defender_coverage_matrix():
    ...
    potential_coverage_matrix = gdal.Open("guarding-policies/abm-runs-learning-memory/defender_coverage_matrix.tif").ReadAsArray()
...
def plot_and_save_defender_coverage(coverage_matrix, output_folder, figsize=(8, 8), 
    ...
    source_file = gdal.Open("guarding-policies/abm-runs-learning-memory/defender_coverage_matrix.tif")
...
if __name__ == "__main__":
    ...
    output_file = os.path.join("guarding-policies/abm-runs-learning-memory/defender_coverage_matrix.tif")
    ...
    output_folder = os.path.join(
        "guarding-policies/abm-runs-learning-memory/model-runs/game_model-v3_1-run-model-with-intervention-v2-no-knowledge/",
        experiment_name,
        starting_location,
        elephant_category,
