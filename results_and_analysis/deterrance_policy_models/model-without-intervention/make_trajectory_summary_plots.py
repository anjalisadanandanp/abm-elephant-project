...
base_folder = os.path.join("/mnt/qdata/abm-elephant-project/aryabhata-runs/model-without-intervention/")

subfolder_path_first = "latitude-1049237-longitude-8570917/solitary_bulls"

food_distribution_models = [
    "random-food-distribition-only-within-agricultural-plots",
    "random-food-distribition-within-plantation-cells",
    "random-food-distribition-within-agricultural-plots-and-other-plantation-cells",
]
        ...
        for thermoregulation_model in thermoregulation_models:
            for slope_tolerance_model in slope_tolerance_models:
                for aggression_model in aggression_models:
                    for month in months:
                        folder_path = os.path.join(base_folder, subfolder_path_first,
                        ...
                        output_folder = os.path.join("results_and_analysis/deterrance_policy_models/model-without-intervention",
