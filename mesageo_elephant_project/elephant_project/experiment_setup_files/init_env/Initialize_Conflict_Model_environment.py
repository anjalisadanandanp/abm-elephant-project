...
class environment():
    ...
    def __init__(self, area_size, resolution):
        ...
        #Saving the files
        #-------------------------------------------------------------------
        self.root_folder_path = os.path.join("mesageo_elephant_project/elephant_project/experiment_setup_files", "environment_seethathode", "Raster_Files_Seethathode_Derived",self.area[self.area_size],self.reso[self.resolution]) 
        #-------------------------------------------------------------------
    ...
    def reproject(self):
        ...
        #1: DEM
        fid = os.path.join("mesageo_elephant_project/elephant_project/experiment_setup_files", "environment_seethathode","Raster_Files_Seethathode_Derived","DEM", "DEM.tif")
        self.reproject_raster_to_different_crs(fid,"DEM")

        #2: LULC
        fid = os.path.join("mesageo_elephant_project/elephant_project/experiment_setup_files", "environment_seethathode","Raster_Files_Seethathode_Derived","Landuse","Landuse.tif")
        self.reproject_raster_to_different_crs(fid,"LULC")

        #3: Population maps

        fid = os.path.join("mesageo_elephant_project/elephant_project/experiment_setup_files", "environment_seethathode","Raster_Files_Seethathode_Derived","Population","Population.tif")
    ...
    def resolution_fixing(self):
        ...
        match_filename = os.path.join("mesageo_elephant_project/elephant_project/experiment_setup_files", "environment_seethathode","Raster_Files_Seethathode_Derived",self.area[self.area_size],"resolution_fixing",self.reso[self.resolution] +".tif")
