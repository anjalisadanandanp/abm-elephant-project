...
class LandUseRewards:
    ...
    def plot_matrices(self, interpolated=None):
        ...
        plt.tight_layout()
        plt.savefig(
            "game_theory_codes/FPL-UE/tests/interpolated_LULC_matrix.png",
            bbox_inches="tight",
            dpi=300,
        )
        plt.close()
    ...
    def plot_coords(self, lat, lon, interpolated=None):
        ...
        plt.tight_layout()
        plt.savefig(
            "game_theory_codes/FPL-UE/tests/interpolated_LULC_matrix_value_at_coordinatex_x_"
            + str(x)
            + "_y_"
            + str(y)
            + ".png",
    ...
    def assign_target_rewards_and_penalties_random(
        ...
        df.to_csv(
            "game_theory_codes/FPL-UE/tests/target_rewards_penalties.csv",
            index=False,
        )
        return df
    ...
    def plot_with_rewards(self, targets_df, interpolated=None, name=None):
        ...
        if interpolated is not None:
            ...
            plt.tight_layout()
            plt.savefig(
                "game_theory_codes/FPL-UE/tests/"
                + name
...
def plot_rewards_comparison(estimated_reward, z, perturbed_reward, eta):
    ...
    plt.savefig('game_theory_codes/FPL-UE/tests/reward_perturbation.png', dpi=300, bbox_inches='tight')
    plt.close()
    return 
...
def plot_defender_regret(defender_regret_values):
    ...
    plt.savefig('game_theory_codes/FPL-UE/tests/defender_regret_plot.png', dpi=300, bbox_inches='tight')
...
def plot_average_regret(average_regret, std_regret, num_plays):
    ...
    plt.tight_layout()
    plt.savefig('game_theory_codes/FPL-UE/tests/average_defender_regret.png', dpi=300, bbox_inches='tight')
    plt.close()
    return
